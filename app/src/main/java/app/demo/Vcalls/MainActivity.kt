...
import app.demo.Vcalls.navigation.NavHostScreen
...
import app.demo.Vcalls.ui.theme.VcallsTheme
...
class MainActivity : FragmentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!savedEmail.isNullOrEmpty() && !savedName.isNullOrEmpty()) {
            initZegoInviteService(APP_ID, APP_SIGN, savedEmail, savedName)
            Log.e("ZegoInit", "User info is missing, cannot init Zego")
        }
